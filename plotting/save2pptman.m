...
% function save2pptman(text,figs)
% Optimized for use with special measure data, but can be used with
% any figure. 
% text is a struct that contains all information for slide: 
    % configch, configvals: saved channel values from smdata (leave empty if
    % not using sm) 
...
% figs: list of figure numbers to put in ppt. 

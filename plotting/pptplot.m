...
%export_callback calls function that performs plotting. calls fplot2ppt2
...
% Last Modified by GUIDE v2.5 07-Apr-2016 15:05:08
...
function b_choose_Callback(hObject, eventdata, handles) %#ok<*INUSL>
...
% --- Executes during object creation, after setting all properties.
function e_figures_CreateFcn(hObject, eventdata, handles) %#ok<*INUSD>
% hObject    handle to e_figures (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function exported_Callback(hObject, eventdata, handles) %#ok<*DEFNU>

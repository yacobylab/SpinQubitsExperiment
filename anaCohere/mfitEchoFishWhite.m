...
out.phaseDataErr = stdParams(2,:); 
out.ampOffsetErr = stdParams(4,:); 
out.ampOffset = out.params(4,:); 
out.tOffset = out.params(5,:); 
out.tOffsetErr = stdParams(5,:); 
freqData = out.params(1,:); 
out.J = freqData*1e3/2/pi; % In MHz. 
out.phaseData=out.params(2,:); 
out.fishPhase = out.params(3,:); 

function [beta1,r,j,COVB,mse,err] = fitwrap(opts, x, y, beta0, model, mask)
...
%  This allows the model to be something like '@(p,x) x*p(1)', which overcomes issues with saving functions to disk.
if ischar(model)
